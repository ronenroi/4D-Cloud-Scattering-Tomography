...
vol = squeeze(gt_extinction(4,:,:,15:30));

load('3sat/FINAL_3D_extinction20.mat')
vol1 = squeeze(estimated_extinction(:,:,15:30,4));

load('2sat/FINAL_3D_extinction20.mat')
vol2 = squeeze(estimated_extinction(:,:,15:30,4));


load('base_line/FINAL_3D_extinction.mat')
vol4 = squeeze(estimated_extinction(:,:,15:30,1));
...
show_3d(ax_mask,vol,"Ground-truth extinction", max(vol(:))*1.1);
set(gca,'linewidth',2)
ylim([0.2 0.6])
...
figure
ax_mask = subplot(1,1,1);
show_3d(ax_mask,vol1,"Recoverd extinction - 3 Satellites", max(vol(:))*1.1);
set(gca,'linewidth',2)
ylim([0.2 0.6])
fig.Renderer='Painters'; 
...
figure
ax_mask = subplot(1,1,1);
show_3d(ax_mask,vol2,"Recoverd extinction - 2 Satellites", max(vol(:))*1.1);
set(gca,'linewidth',2)
ylim([0.2 0.6])
fig.Renderer='Painters'; 
...
figure
ax_mask = subplot(1,1,1);
show_3d(ax_mask,vol4,"Recoverd extinction - Base-line", max(vol(:))*1.1);
set(gca,'linewidth',2)
ylim([0.2 0.6])
fig.Renderer='Painters'; 
