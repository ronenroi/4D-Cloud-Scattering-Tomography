...
C       Interpolates the output data to the BOMEX2 grid points (those >OLDNPTS)
...
C     Each BOMEX2 point is located in a cell, and the two parent grid points
...
C       Interpolates the spherical harmonic radiance array to the BOMEX2
