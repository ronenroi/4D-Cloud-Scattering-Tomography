...
close all
clear
v = VideoWriter('Cloud1_3sat_video.avi', 'Motion JPEG AVI');
v.FrameRate = 10;
...
c = colorbar;
colormap(ax,'cool')
c.Position = [0.924,0.219317903459121,0.020668285662889,0.612166499498496];
c.Label.String = 'Extinction [1/km]';
c.FontSize=20;
c.Label.Position = [0.370175462020071,87.2519714969328,0];
c.Label.Rotation = 0;
